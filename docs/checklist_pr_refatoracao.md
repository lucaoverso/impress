...
Sinais de que o PR esta grande demais:

- altera router, service, repository, frontend e migration sem necessidade
- mistura limpeza estrutural com correcao funcional
- exige contexto historico excessivo para ser revisado
...
O PR ideal de refatoracao e pequeno, claro e seguro. Ele melhora a estrutura sem surpreender no comportamento, ajuda a reduzir o legado e deixa a proxima etapa mais facil de executar.
