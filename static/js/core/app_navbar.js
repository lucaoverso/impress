(function (window, document) {
    const FEATURES = [
        ...
        ["agendamento", "/agendamento/meus-agendamentos", "Meus agendamentos", "Consulte e cancele suas reservas"],
        ["agendamento", "/agendamento/calendario", "Agenda de recursos", "Consulte reservas e horários disponíveis"],
        ...
        ["preconselho", "/preconselho", "Meu preenchimento do pré-conselho", "Registre sinalizações pedagógicas"],
        ["preconselho", "/preconselho/consolidacao", "Consolidação do pré-conselho", "Reúna registros por estudante e período"],
        ["preconselho", "/preconselho/reavaliacao", "Reavaliação do pré-conselho", "Acompanhe resultados de reavaliação"],
        ["preconselho", "/preconselho/relatorios", "Relatórios do pré-conselho", "Consulte indicadores institucionais"],
        ["preconselho", "/preconselho/rav", "Acompanhamento RAV", "Consulte estudantes, habilidades e ações"],
