...
def downgrade(conn: sqlite3.Connection):
    # SQLite nao permite remover colunas de forma segura sem reconstruir tabelas.
    # Mantemos downgrade sem destruicao para preservar dados de producao.
    conn.commit()


def main():
    parser = argparse.ArgumentParser(
        description="Migration: adiciona marcadores de RAV no pre-conselho."
    )
