...
import routers.ocorrencias_router as ocorrencias_router_module
...
import routers.pcpi_router as pcpi_router_module
...
ocorrencias_router_module = _reload_or_import(ocorrencias_router_module)
pcpi_router_module = _reload_or_import(pcpi_router_module)
...
ocorrencias_router = ocorrencias_router_module.router
pcpi_router = pcpi_router_module.router
