...
atualizar_habilidade_rav_pre_conselho_dados = proxy(
...
buscar_habilidades_rav_pre_conselho_por_ids = proxy(
...
criar_habilidade_rav_pre_conselho = proxy("criar_habilidade_rav_pre_conselho")
...
listar_habilidades_rav_pre_conselho = proxy("listar_habilidades_rav_pre_conselho")
...
listar_rav_pre_conselho_por_turma = proxy("listar_rav_pre_conselho_por_turma")
